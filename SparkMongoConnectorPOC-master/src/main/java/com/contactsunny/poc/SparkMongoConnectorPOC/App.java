...
public class App implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        SparkConf sparkConf = new SparkConf()
                .setMaster("local")
                .set("spark.mongodb.input.uri", mongoDbConnectionUri + ".devices")
                .setAppName("SparkMongoConnectorPOC");

        Map<String, String> tweetsReadOverrides = new HashMap<>();
        tweetsReadOverrides.put("collection", "devices");
        tweetsReadOverrides.put("readPreference.name", "primaryPreferred");
